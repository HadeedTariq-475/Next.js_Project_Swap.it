...
export default function CategoryFilterBar({ filters, setFilters }) {
    return (
        <div className="flex flex-wrap gap-10 mb-6 mt-5 justify-between text-sm font-medium text-black px-4">
            {/* Type */}
            ...
            <div className="flex flex-col">
                ...
                <select max={5} min={0}
                className="border border-gray-300 rounded-md px-3 py-1 focus:outline-none w-[110px]"
            ...
            <div className="flex flex-col">
                ...
                <input
                    type="number"
                    className="border border-gray-300 rounded-md w-20 px-2 py-1 focus:outline-none"
                ...
                <input
                    ...
                    className="border border-gray-300 rounded-md w-24 px-2 py-1 focus:outline-none"
